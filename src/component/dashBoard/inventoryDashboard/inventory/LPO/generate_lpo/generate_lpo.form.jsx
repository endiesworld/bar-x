...
import {generateLPO}from "../../../../../../firebase/inventory/generate_lpos_firebase" ;
...
lpoInputFieldWidthSize, max_lpoInputFieldWidthSize, setTotalValue, processOnSubmit} from "../lpo-tools/lpo_data_processor" ;
...
import {getlpoNumbers}from "../../../../../../firebase/inventory/generate_lpos_firebase" ;
...
function GenerateLPO({ deviceType, userDetails, addItemToLPO , uid}) {
    ...
    const [isLPODataReady, setLpoDataAvailability] = useState("00000") ;
...
return (
        <ParentDiv>
                <LPOFormik  enableReinitialize={true} initialValues = {{...initialValues, uid: uid, poNumber: isLPODataReady }} onSubmit={processOnSubmit(generateLPO, navigate)}>
                    {(formProps) =>
                    <FormikForm>
                        <Header>
                            <UserDetailsSection  >
